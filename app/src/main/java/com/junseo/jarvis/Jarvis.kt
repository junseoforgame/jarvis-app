...
class MainActivity : AppCompatActivity() {
    ...
    private fun makeChannel() {
        val ch = NotificationChannel(CHANNEL, "JARVIS", NotificationManager.IMPORTANCE_DEFAULT)
    ...
    inner class Bridge {
        ...
        fun alarm(hour: Int, minute: Int, label: String): String {
            // 먼저 시계 앱에 맡기고, 받아주는 앱이 없으면 직접 잰다
            try {
